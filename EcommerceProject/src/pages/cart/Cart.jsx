...
function Cart() {
  ...
  //Uses the useEffect hook to calculate the total amount whenever the cartItems state changes
...
//Defines a function buyNow to handle the payment process.
  const buyNow = async () => {
...
//information ko Database me store karne ke liye 
    const addressInfo = {
      name,
      address,
      pincode,
    ...
    var options = {
      key: "rzp_test_NaXkj4S573q5yY",
      key_secret: "1OxFOJyibuiM7du0cpy0d2wi",
